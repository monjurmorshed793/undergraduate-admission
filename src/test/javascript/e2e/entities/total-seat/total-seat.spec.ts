...
import {
  TotalSeatComponentsPage,
  /* TotalSeatDeleteDialog, */
  TotalSeatUpdatePage
} from './total-seat.page-object';
...
describe('TotalSeat e2e test', () => {
  ...
  /* it('should delete last TotalSeat', async () => {
        ...
        expect(await totalSeatDeleteDialog.getDialogTitle())
            .to.eq('Are you sure you want to delete this Total Seat?');
