...
import { FaProgramComponentsPage, FaProgramDeleteDialog, FaProgramUpdatePage } from './fa-program.page-object';
...
describe('FaProgram e2e test', () => {
  ...
  it('should delete last FaProgram', async () => {
    ...
    expect(await faProgramDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Fa Program?');
