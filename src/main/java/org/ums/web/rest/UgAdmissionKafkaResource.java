...
@RestController
@RequestMapping("/api/ug-admission-kafka")
public class UgAdmissionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(UgAdmissionKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public UgAdmissionKafkaResource(KafkaProperties kafkaProperties) {
